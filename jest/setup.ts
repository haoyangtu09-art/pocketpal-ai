...
import {backgroundStore as mockBackgroundStore} from '../__mocks__/stores/backgroundStore';
import {searchStore as mockSearchStore} from '../__mocks__/stores/searchStore';
...
jest.mock('../src/store', () => {
  ...
  return {
    ...
    backgroundStore: mockBackgroundStore,
